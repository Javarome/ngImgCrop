 ...
 * License: MIT
 *
 * Generated at Wednesday, February 3rd, 2016, 11:38:59 AM
 */
(function() {
'use strict';
...
crop.service('cropEXIF', ['$log', function ($log) {
  ...
  function findEXIFinJPEG(file) {
    ...
    while (offset < maxOffset) {
      ...
      switch (marker) {
        case 0xE0:
          return readJFIFData(dataView, offset, segmentLength - 2);
        case 0xE1:
  ...
  function readJFIFData(file, start) {
    if (getStringFromDB(file, start, 4) != "JFIF") {
      $log.error("Not valid JFIF data! " + getStringFromDB(file, start, 4));
      return false;
    }
